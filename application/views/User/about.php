		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="row about-tp mt-md-5 pt-5">
				<div class="col-lg-6 welcome-left">
					<h3>Welcome</h3>
					<h4>A loan is when money is given to another party in exchange for repayment of the loan principal amount plus interest.</h4>
					<p>Lenders will consider a prospective borrower's income, credit score, and debt levels before deciding to offer them a loan.</p>
				</div>
				<div class="col-lg-6 welcome-right">
					<div class="welcome-right-top">
						<img src="<?php echo base_url('Asset/User/images/g2.jpg')?>" alt="" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
