...
<div class="w3layouts-main">
	<h2>Register Now</h2>
		<form action="<?php echo base_url('index.php/Admin_controller/register_insert')?>" method="post">
		...
		<p>Already Registered.<a href="<?php echo base_url('index.php/Admin_Controller/login')?>">Login</a></p>
</div>
</div>
